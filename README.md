# ¡Hola!, Bienvenido a mi muro, mi nombre es Sergio Medina y aspiro a desarrollar una carrera profesional en el lado del servidor (Backend), así como crear apps y juegos para móvil y Pc. 
